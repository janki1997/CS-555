...
def List_recent_death(individuals: List[Individual],families:List[Family]):
    ...
    for family in families:
        if family.marr:
            if family.husb in death_list and family.wife in death_list and family.chil in death_list:
...
class TestApp(unittest.TestCase):
    ...
    def test_List_recent_deat(self):
        ...
        self.assertEqual(List_recent_death(indi,fami),["I0"])
